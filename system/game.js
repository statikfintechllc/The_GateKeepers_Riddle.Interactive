...
async function requestAICurated() {
    ...
    const issueTitle = encodeURIComponent('🤖 AI Riddle Request');
    const issueBody = encodeURIComponent(`## AI Curated Riddle Request

I would like to request a new riddle generated by the AI Riddle Finder Agent.

### Preferences (optional)
- **Riddle Type**: Mixed (or specify: logic, wordplay, philosophical, technical)
- **Difficulty**: Hard (or specify: medium, hard, expert)

### Additional Notes
[Any specific themes or topics you'd like the riddle to explore]

---
*This issue will automatically trigger the Riddle Finder Agent workflow. The new riddle will be added to the game after review.*`);
    
    const issueLabels = 'ai-riddle-request';
    ...
    if (feedback) {
        feedback.textContent = '📝 Opening GitHub to create your AI riddle request. No sign-in needed - just submit the issue!';
